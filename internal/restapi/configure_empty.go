...
import (
	...
	"github.com/abyssparanoia/application-boilerplate/internal/restapi/operations"
)

//go:generate swagger generate server --target ../../internal --name  --spec ../../swagger/reference/api.v1.yaml --model-package restapi/restmodels
