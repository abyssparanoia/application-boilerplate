...
type GetUsersUserIDOK struct {
	...
	/*
	  In: Body
	*/
	Payload *GetUsersUserIDOKBody `json:"body,omitempty"`
}
...
func (o *GetUsersUserIDOK) WithPayload(payload *GetUsersUserIDOKBody) *GetUsersUserIDOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users user Id o k response
func (o *GetUsersUserIDOK) SetPayload(payload *GetUsersUserIDOKBody) {
	o.Payload = payload
}
